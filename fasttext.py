...
model_ted = FastText(sentences=sentences_ted, size=100, window=5, min_count=1, workers=4, sg=0)
...
randomforest.randomForest(X_train, X_test, y_train, y_test,"FastText com media do embbeding entre palavras do documento FastText")
print("\n")
...
randomforest.randomForest(X_train, X_test, y_train, y_test,"FastText com media do embbeding entre palavras do documento FastText+OHE")
print("\n")
...
randomforest.randomForest(X_train, X_test, y_train, y_test,"FastText com media do embbeding entre palavras do documento FastText+TFIDF")
print("\n")
...
randomforest.randomForest(X_train, X_test, y_train, y_test,"FastText com media do embbeding entre palavras do documento FastText+OHE+TFIDF")
print("\n")
...
X_train, X_test, y_train, y_test = train_test_split(resultado, label,test_size=0.3,stratify = label,random_state =5)
randomforest.randomForest(X_train, X_test, y_train, y_test,"FastText com media do embbeding da palavra individual FastText")
print("\n")
X_train, X_test, y_train, y_test = train_test_split(pd.concat([resultado,data],axis =1), label,test_size=0.3,stratify = label,random_state =5)
randomforest.randomForest(X_train, X_test, y_train, y_test,"FastText com media do embbeding da palavra individual FastText+OHE")
print("\n")
X_train, X_test, y_train, y_test = train_test_split(sparse.hstack((csr_matrix(resultado),csr_matrix(tfidf))), label,test_size=0.3,stratify = label,random_state =5)
randomforest.randomForest(X_train, X_test, y_train, y_test,"FastText com media do embbeding da palavra individual FastText+TFIDF")
print("\n")
X_train, X_test, y_train, y_test = train_test_split(sparse.hstack((csr_matrix(resultado),csr_matrix(data),csr_matrix(tfidf))), label,test_size=0.3,stratify = label,random_state =5)
randomforest.randomForest(X_train, X_test, y_train, y_test,"FastText com media do embbeding da palavra individual FastText+OHE+TFIDF")
print("\n")
