...
def sgd(X_train, X_test, y_train, y_test,string,max_interations):   
    rnd_clf = SGDClassifier(loss="log", penalty="l2", max_iter = max_interations,random_state = 10)
    ...
    print("O f1Score micro do Stocastico gradiente descendente com ",string, " e ",max_interations," interacoes é: ",micro)
    print("O f1Score macro do Stocastico gradiente descendente com ",string, " e ",max_interations," interacoes é: ",macro)        